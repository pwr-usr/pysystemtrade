...
> **Archive provenance**
>
> Source: [official XTTrader web manual](https://dict.thinktrader.net/nativeApi/xttrader.html)  
...
> **Staleness warning:** this web page's change history ends at 2024-06-27. The pinned package manual continues through 2025-06-03. Prefer [`../package-docs/xttrader.md`](../package-docs/xttrader.md) for release `250807.1.2`.
