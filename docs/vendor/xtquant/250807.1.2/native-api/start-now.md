...
> **Archive provenance**
>
> Source: [official XTQuant quick start](https://dict.thinktrader.net/nativeApi/start_now.html)  
...
> **Staleness warning:** this web page lists Python 3.6 through 3.12. The pinned `250807.1.2` wheel metadata also lists Python 3.13. Treat the pinned package and its bundled manuals as authoritative for this archive.
