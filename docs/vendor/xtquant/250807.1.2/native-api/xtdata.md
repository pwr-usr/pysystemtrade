...
> **Archive provenance**
>
> Source: [official XTData web manual](https://dict.thinktrader.net/nativeApi/xtdata.html)  
> Retrieved: `2026-08-09T17:22:27Z`  
> Transformation: the VuePress article body was converted to GFM; site navigation, scripts, syntax-highlighting spans, and UI chrome were removed.  
> **Staleness warning:** this web page's change history ends at 2024-05-27. The pinned package manual continues through 2024-10-16 and the pinned package contains later APIs. Prefer [`../package-docs/xtdata.md`](../package-docs/xtdata.md) for release `250807.1.2`.
...
- 参数
  ...
  - extend_param:dict,模型的入参,{参数名:参数值},形如{'a':1,'\_\_basket':{}};
