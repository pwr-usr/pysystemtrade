...
> **Archive provenance**
>
> Source: [official futures data dictionary](https://dict.thinktrader.net/dictionary/future.html)  
...
> **Scope warning:** this page documents market-data products and examples, not the futures order-routing contract. Availability remains edition-, entitlement-, server-, and broker-dependent.
...
![](https://dict.thinktrader.net/assets/迅投数据服务_加权公式-b1b27ec5.png)
